...
class AuthorPage extends StatelessWidget {
  ...
  Future<void> _openTikTok() async {
    // Android TikTok app deep link — falls back to browser if app not installed
    final appUri = Uri.parse(
        'intent://www.tiktok.com/@guwanchanmatow#Intent;package=com.zhiliaoapp.musically;scheme=https;end');
    final webUri = Uri.parse(AppStrings.tiktokUrl);
  ...
  Future<void> _openImo(BuildContext context) async {
    // Standard phone dialer — guaranteed to work on all Android phones
    final telUri = Uri(scheme: 'tel', path: AppStrings.imoNumber);
  ...
  Future<void> _openDeveloperEmail() async {
    final uri = Uri(
      ...
      queryParameters: {
        'subject': 'Doganlar Programmasy - Habar',
      },
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _ContactRow(
                          ...
                          platformName: AppStrings.developerName,
                          detail: AppStrings.developerEmail,
                          onTap: _openDeveloperEmail,
                          gradientColors: isDark
